...
import TelaMapaTrajeto from './screens/TelaMapaTrajeto';
    ...
    <NavigationContainer>
      <Stack.Navigator screenOptions={{headerShown: false}}>
        {store.user.access_token ? (
          <>
            <Stack.Screen name="entregas" component={TelaEntregas} />
            <Stack.Screen
              name="disponiveis"
            ...
            />
            <Stack.Screen name="mapaTrajeto" component={TelaMapaTrajeto} />
          ...
          <>
            <Stack.Screen name="loginCadastro" component={TelaLoginCadastro} />
          </>
        )}
      </Stack.Navigator>
    </NavigationContainer>
